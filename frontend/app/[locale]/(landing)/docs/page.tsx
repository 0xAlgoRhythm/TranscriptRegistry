  ...
  return <div className="docs-root">
      ...
      <header className="docs-topbar">
        <div className="docs-topbar-inner">
          <Link href="/" className="docs-logo">
            ...
            <span className="docs-logo-name">{t("credAxis")}</span>
            <span className="docs-logo-badge">{t("docs")}</span>
          </Link>

          <nav className="docs-top-links">
            <a href="https://credaxis.app" target="_blank" rel="noopener noreferrer">{t("platform")}</a>
            <a href="/verify" target="_blank" rel="noopener noreferrer">{t("verifier")}</a>
            <a href="mailto:support@credaxis.app">{t("supportcredaxisapp")}</a>
          </nav>

          <button id="docs-mobile-menu-btn" className="docs-mobile-toggle" onClick={() => setMobileNavOpen(!mobileNavOpen)} aria-label="Toggle navigation">
            <span />
            <span />
            <span />
          </button>
      ...
      <div className="docs-layout">
        ...
        <aside className={`docs-sidebar ${mobileNavOpen ? "open" : ""}`}>
          <DocsNav sections={sections} activeSection={activeSection} onSelect={scrollTo} />
        </aside>
        ...
        <main className="docs-main" ref={mainRef}>
          ...
          <footer className="docs-footer">
            <div className="docs-footer-inner">
              <p>{t("2025CredAxisBuilton")}</p>
              <div className="docs-footer-links">
                <a href="/">{t("home")}</a>
                <a href="/verify">{t("verify")}</a>
                <a href="mailto:support@credaxis.app">{t("support")}</a>
                <a href="mailto:info@credaxis.app">{t("contact")}</a>
              </div>
            </div>
          </footer>
        </main>
